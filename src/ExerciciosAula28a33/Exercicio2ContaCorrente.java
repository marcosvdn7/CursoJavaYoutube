...
public class Exercicio2ContaCorrente {
	...
	public static void main(String[] args) {
		ContaCorrente conta1 = new ContaCorrente(123546, 2000, 500, true);
		...
		double valor;
		double limiteMax = conta1.getLimite();
		
		while (encerrar == false) {
			System.out.println("-------------------------------");
			System.out.println("Numero da conta: " +conta1.getNumConta());
			System.out.println("Possui cheque especial? " +(conta1.getEspecial() == true ? "Sim.\nLimite Especial: R$" +conta1.getLimite() : "Não."));
